...
export const defaultPrizeList = <IPrizeConfig[]>[
    ...
    },
    {
        ...
        picture: {
            id: '3',
            name: '小米17',
            url: 'https://cdn.cnbj1.fds.api.mi-img.com/nr-pub/202509222148_ffb7adfa456ae103f16f2517b2e07908.png',
        },
        separateCount: {
            enable: false,
            countList: [],
    ...
    },
    {
        ...
        picture: {
            id: '4',
            name: '小米17 Pro Max',
            url: 'https://cdn.cnbj1.fds.api.mi-img.com/nr-pub/202509222137_0f5648ca22c47fcd041c4026f11a927f.png',
        },
        separateCount: {
            enable: false,
            countList: [],
